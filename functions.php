...
function desilicious_custom_post() {
  ...
  $Salad_args = array(
    ...
    $testimonial_label = array(
        ...
        'singular_name' => __('Testmimonial', 'textdomain'),
        'add_new' => __('Add Testmimonial', 'textdomain'),
        'edit_item' => __('Edit Testmimonial', 'textdomain'),
        'add_new_item' => __('Add New Testmimonial', 'textdomain'),
